...
class PatternManager:
    ...
    def _compile_patterns() -> Dict[str, re.Pattern]:
        ...
        return {
            ...
            'recipient': re.compile(r'수취인명[\s\t]*(.*?)[\s\t]*연락처1[\s\t]*(.*?)[\s\t]*연락처2', re.DOTALL),
...
class TextProcessor:
    ...
    def clean_address_text(self, address: str, recipient_name: str, contact1: str) -> str:
        ...
        return self.pm.patterns['cleanup_whitespace'].sub(' ', address).strip()
    ...
    def extract_delivery_info(self, text: str, recipient_name: str, contact1: str) -> str:
        ...
        try:
            ...
            if match:
                ...
                return cleaned_address if len(cleaned_address) > 5 else "배송지 정보가 부족합니다"
